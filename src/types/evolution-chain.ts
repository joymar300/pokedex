// To parse this data:
//
//   import { Convert, Evolutionschain } from "./file";
//
//   const evolutionschain = Convert.toEvolutionschain(json);
//
...
export class Convert {
    public static toEvolutionschain(json: string): Evolutionschain {
        return cast(JSON.parse(json), r("Evolutionschain"));
    }

    public static evolutionschainToJson(value: Evolutionschain): string {
        return JSON.stringify(uncast(value, r("Evolutionschain")), null, 2);
    }
}
